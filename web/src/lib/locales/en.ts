...
export const en = {
  ...
  'pe.slug': 'slug',
  'pe.slugHint':
    'Stable id for a mod: keeps the on/off choice across updates when the filename changes, and keeps it the same mod when it is repinned to another publisher.',
  ...
  'pe.fileId': 'file id',
  'pe.repo': 'GitHub repository, owner/name',
  'pe.tag': 'release tag',
  'pe.asset': 'release asset filename',
  'pe.cfAssetsUnsupported': 'Files from a publisher are mods, not pack assets',
  ...
  'mm.curseforgeHint': 'these bytes are published on CurseForge: {name}',
